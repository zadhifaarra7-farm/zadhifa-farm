    ...
    return (
        <Card variant="premium" className="p-6 relative overflow-hidden">
            ...
            <div className="flex items-center gap-2 mb-6 text-gold-400">
                ...
                <span className="text-sm font-bold tracking-widest uppercase">AI Price Forecast</span>
            </div>

            <div className="space-y-6">
                <div>
                    <div className="text-sm text-text-muted mb-1">Projected Peak Date</div>
                ...
                <div>
                    <div className="text-sm text-text-muted mb-1">Expected Market Surge</div>
                    ...
                    <p className="text-xs text-text-muted mt-2 text-right">Confidence Score: 89%</p>
                </div>

                <div className="p-4 bg-surface/50 rounded-xl border border-white/5 space-y-3">
                    <div className="flex justify-between items-center text-sm">
                        <span className="text-text-muted">Current Avg. Price/kg</span>
                        <span className="font-mono font-medium">Rp 95,000</span>
                    </div>
                    <div className="flex justify-between items-center text-sm">
                        <span className="text-text-muted">Forecasted Peak</span>
                ...
                <div className="text-xs text-center text-farm-500/60 bg-farm-500/5 py-2 rounded">
                    * Based on 5-year historical market data
                </div>
            </div>
        </Card>
    );
